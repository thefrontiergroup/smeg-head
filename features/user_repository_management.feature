Feature: User Repository Management
  ...
  Scenario: Creating a new valid repository
    Given I am a new, authenticated user with the name "sutto"
    And I am on the create user repository page
    ...
    Then I should have a repository with the name "Totally not a gaming site"
    And I should be redirected to the page for the "sutto/totally-not-a-gaming-site" repository
  ...
  Scenario: Removing a repository
    ...
    And I have a repository with the name "Test Repository"
    And I am editing the current repository
    When I click 'Remove this Repository'
